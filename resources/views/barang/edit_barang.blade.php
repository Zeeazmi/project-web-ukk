        ...
        <div class="row gx-3">
            <div class="col-lg-12 col-sm-6 col-12">
                <div class="card mb-3">
                    <div class="card-body">
                        <div class="m-0">
                            <label class="form-label" for="barang">barang Barang</label>
                            <input type="text" class="form-control" id="barang" name="barang"
                                value="{{ $barang->barang }}" placeholder="Enter text" />
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="m-0">
                            ...
                            <input type="text" class="form-control" id="harga" name="harga"
                                value="{{ $barang->harga }}" placeholder="Enter text" />
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="m-0">
                            ...
                            <input type="text" class="form-control" id="stok" name="stok"
                                value="{{ $barang->stok }}" placeholder="Enter text" />
                        </div>
                    </div>
                </div>
            </div>
