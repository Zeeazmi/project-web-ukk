...
@section('content')
    ...
    <div class="app-hero-header d-flex align-items-start">
        ...
        <ol class="breadcrumb d-none d-lg-flex">
            ...
            <li class="breadcrumb-item" aria-current="page">Edit Costumer</li>
        </ol>
        <!-- Breadcrumb end -->
                    ...
                    <div class="card-body">
                        <div class="m-0">
                            ...
                            <input type="text" class="form-control" id="costumer" name="costumer"
                                value="{{ $costumer->costumer }}" placeholder="Enter text" />
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="m-0">
                            ...
                            <input type="text" class="form-control" id="alamat" name="alamat"
                                value="{{ $costumer->alamat }}" placeholder="Enter text" />
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="m-0">
                            ...
                            <input type="text" class="form-control" id="no_telephon" name="no_telephon"
                                value="{{ $costumer->no_telephon }}" placeholder="Enter text" />
                        </div>
                    </div>
                </div>
            </div>
